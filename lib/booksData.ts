...
export const AUDIOBOOKS: AudioBook[] = [
  ...
  { id: '4', title: "The People's Law Book", author: 'Robert C. Griffin', genre: 'Non-Fiction', runtime: '1.6h', color: '#0D1A2A', image: '/images/peoples-law-book.jpg', audio: '/audio/peoples-law-book-sample.mp3' },

...
export const AUDIOBOOKS: AudioBook[] = [
  ...
  { id: '2', title: 'The Psychology of Insurance', author: 'Karman Jones', genre: 'Business', runtime: '9h 04m', color: '#1A2A1A', image: '/images/psychology-of-insurance.jpg', audio: '/audio/psychology-of-insurance-sample.mp3' },

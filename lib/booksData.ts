...
export const AUDIOBOOKS: AudioBook[] = [
  { id: '1', title: 'Aṣísẹhìndé', author: 'Gbadebo Babsalaam & Oluwaseun Babsalaam', genre: 'Fiction', runtime: '11h 22m', color: '#2A1F3D', image: '/images/atlas-cover.jpg', audio: '/audio/asisehinde-sample.mp3' },

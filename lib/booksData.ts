...
export const AUDIOBOOKS: AudioBook[] = [
  ...
  { id: '5', title: 'Waiting to Die', author: 'Feltus Taylor, Jr., Edited By Monique Morrison', genre: 'Non-Fiction', runtime: '11h', color: '#1A1A2A', image: '/images/waiting-to-die.jpg' },

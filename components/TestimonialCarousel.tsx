...
const TESTIMONIALS = [
  {
    quote: "AM doesn't just read words — they inhabit them. Our audiobook climbed the charts within a week of release, and listener reviews kept mentioning the narration. That never happens.",
    name: 'Rachel Okoye',

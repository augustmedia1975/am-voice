...
const SERVICES = [
  ...
  {
    title: 'Trailer & Promo',
    description: 'The theatrical baritone when you need it. The conspiratorial whisper. The voice that makes a preview feel like an event. Adam has been the voice behind campaigns that moved audiences worldwide.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Clear, engaging, authoritative — without being clinical. Adam transforms dense training content into something people actually retain. Trusted by Fortune 500 companies and independent educators alike.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
